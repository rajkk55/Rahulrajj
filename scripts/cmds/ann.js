...
module.exports = {
  config: {
    name: "ann",//set name of cmd acc to your group
    version: "1.0",
    role: 0,
    author: "𝗞𝘀𝗵𝗶𝘁𝗶𝘇 x Pain",//dont change
    shortDescription: "",
    longDescription: "Send a random video link from a Anime Nova Nepal Facebook group",//set this acc to your group
    category: "fbgroups",
    dependencies: {
      axios: "",
    },
  ...
  onStart: async function ({ api, event }) {
    try {
      ...
      const groupId = "999022784584554";//this is group id (https://www.facebook.com/groups/{999022784584554})copy link of group to see group id and replace it
        ...
        if (unsentVideos.length === 0) {
          ...
          videoResponse.data.on("end", async () => {
            if (fs.existsSync(filePath)) {
              ...
              await api.sendMessage(
                {
                  body: "𝗥𝗮𝗻𝗱𝗼𝗺 𝘃𝗶𝗱𝗲𝗼 𝗳𝗿𝗼𝗺 Anime Nova Nepal  𝗳𝗯 𝗴𝗿𝗼𝘂𝗽. 💫",// chnage this according to your group
