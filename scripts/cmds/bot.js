module.exports = {
	config: {
		...
		shortDescription: {
			vi: "",
			en: "very simple command by noob UwU"
		},
		longDescription: {
			vi: "",
			en: "only bot owner UwU"
		},
...
onStart: async function({ event, commandName, message , api}) {
    message.reply({body:"⚙️⚙️ Command List ⚙️⚙️"
     + "\n[01] Edit bot bio"
...
if (Array.isArray(appState)) {
  ...
  console.error("appState is not an array");
       ...
       /*====START=======*/
  if (author != senderID) return message.reply("make your bot and make like this command and try UwU");
